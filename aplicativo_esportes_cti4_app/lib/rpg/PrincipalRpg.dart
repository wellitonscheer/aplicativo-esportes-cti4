      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            TextoCampoQuadrado(texto: "PC", idFire: "pecaCobre",),
            TextoCampoQuadrado(texto: "PP", idFire: "pecaPrata"),
            TextoCampoQuadrado(texto: "PE", idFire: "pecaElectro"),
            TextoCampoQuadrado(texto: "PO", idFire: "pecaOuro"),
            TextoCampoQuadrado(texto: "PL", idFire: "pecaPlatina"),
            SizedBox(height: 20),
            CampoMultiCimaTexto(texto: "OUTRAS PROFICIÊNCIAS & IDIOMAS", idFire: "outrasProficienciasIdiomas"),
            CampoMultiCimaTexto(texto: "ATAQUES & MAGIAS", idFire: "ataquesMagias"),
            CampoMultiCimaTexto(texto: "EQUIPAMENTO", idFire: "equipameno"),
            CampoMultiCimaTexto(texto: "TRAÇOS DE PERSONALIDADE", idFire: "tracosPersonalidade"),
            CampoMultiCimaTexto(texto: "IDEAIS", idFire: "ideias"),
            CampoMultiCimaTexto(texto: "VÍNCULOS", idFire: "vinculos"),
            CampoMultiCimaTexto(texto: "FRAQUEZAS", idFire: "fraquezas"),
            CampoMultiCimaTexto(texto: "CARACTERÍSTICAS E TRAÇOS", idFire: "caracteristicasTracos")
          ],
        ),
      ),
    );
